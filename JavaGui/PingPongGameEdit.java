...
public class PingPongGameEdit extends JPanel implements KeyListener {
	private Ball ball;
	protected Score score;
	private Racquet racquet1;
	private Racquet racquet2;
	
	public PingPongGameEdit() {
	...
	public static void main(String[] args) {
		...
		PingPongGameEdit game = new PingPongGameEdit();
		frame.add(game);
	...
	class Ball {
		...
		private PingPongGameEdit game;
		private Color color;
		
		public Ball(PingPongGameEdit game, Color color) {
			this.game = game;
			this.color = color;
		}
	...
	class Racquet {
		...
		public Racquet(PingPongGameEdit game, int x, int y, Color color) {
			this.game = game;
			this.x = x;
			this.y = y;
			this.color = color;
